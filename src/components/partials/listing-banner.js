...
class InstagramBanner extends React.Component {
	render() {
		return (
			<a className="banner-instagram" target="_blank" rel="noopener" href={config.social.instagramURL}>
				<div className="instagram-text">
					<strong>Instagram</strong>'da'<br />
					bizi takip <br />
					ediyor musunuz?
				</div>
				<Image className="instagram-image banner-image" bg={!this.props.mobile} src={image_instagram} />
			</a>
		)
	}
}
...
class YoutubeBanner extends React.Component {
	render() {
		return (
			<a className="banner-youtube" target="_blank" rel="noopener" href={config.social.youtubeURL}>
		...
		return (
			<div className="banner-hr">
				<div className="hr-content">
					...
					<Btn href="mailto:kariyer@minoto.com" className="content-cta" tag="a" uppercase wide>CV Gönder</Btn>
				</div>
			</div>
		)
	}
